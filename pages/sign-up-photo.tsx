...
export default function SignUpPhoto() {
  ...
  useEffect(() => {
    ...
    const userForm = JSON.parse(getLocalStorageForm!);
    setLocalStorageForm(userForm);
  }, []);
  ...
  const onSubmit = async () => {
    ...
    data.append('email', localStorageForm.email);
    data.append('password', localStorageForm.password);
    data.append('phoneNumber', '082277189099');
    data.append('username', localStorageForm.name);
    data.append('name', localStorageForm.name);
