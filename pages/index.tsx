  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Kami menyediakan juataan cara untuk membantu player memenangkan game." />
        <meta property="og:title" content="StoreGG - Get a New Experience in Gaming" />
        <meta property="og:description" content="Kami menyediakan juataan cara untuk membantu player memenangkan game." />
