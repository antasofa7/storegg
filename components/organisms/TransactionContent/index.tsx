...
import { HistroyTransactionTypes } from '../../../services/data-types';
                ...
                <div className="row mt-30 mb-20">
                    <div className="col-lg-12 col-12 main-content">
                        <div id="list_status_title">
                            <ButtonTab onClick={() => onTabClicked('all')} title="All Trx" active={tab === 'all'} />
                            <ButtonTab onClick={() => onTabClicked('pending')} title="Pending" active={tab === 'pending'} />
                            <ButtonTab onClick={() => onTabClicked('success')} title="Success" active={tab === 'success'} />
                            <ButtonTab onClick={() => onTabClicked('failed')} title="Failed" active={tab === 'failed'} />
                        </div>
                    </div>
                </div>
